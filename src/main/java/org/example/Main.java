...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        pharmacy.save("Prophilax",new Medication("Prophilax","available",10));
        pharmacy.save("Blastol",new Medication("Blastol","not_available",5));
        pharmacy.save("Sinolum",new Medication("Sinolum","available",20));

        pharmacy.delete("Prophilax");
